...
import Image from "../../Workbook/Helpers/Image"
import Underline from '@tiptap/extension-underline'
import TextAlign from '@tiptap/extension-text-align'
import Iframe from "../../Workbook/Helpers/iframe"
import Heading from "../../Workbook/Helpers/heading"
  ...
  methods:{
    ...
    async loadWorkBook(){
      ...
      if (this.editor && this.workBook) {
        this.editor.commands.insertContent(this.workBook.sections[this.section])
      }
    },
